(function (factory) {
    ...
    var stringifyTask = function (task) { return "{entryPoint: " + task.entryPoint.name + ", formatProperty: " + task.formatProperty + ", processDts: " + task.processDts + "}"; };
