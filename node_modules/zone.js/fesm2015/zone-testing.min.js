 ...
 * found in the LICENSE file at https://angular.io/license
 */
Zone.__load_patch("asynctest",(e,t,n)=>{function r(e,n,r,s){const i=t.current,o=t.AsyncTestZoneSpec;if(void 0===o)throw new Error("AsyncTestZoneSpec is needed for the async() test helper but could not be found. Please make sure that your environment includes zone.js/dist/async-test.js");const c=t.ProxyZoneSpec;if(void 0===c)throw new Error("ProxyZoneSpec is needed for the async() test helper but could not be found. Please make sure that your environment includes zone.js/dist/proxy.js");const a=c.get();c.assertPresent();const u=t.current.getZoneWith("ProxyZoneSpec"),l=a.getDelegate();return u.parent.run(()=>{const e=new o(()=>{a.getDelegate()==e&&a.setDelegate(l),e.unPatchPromiseForTest(),i.run(()=>{r()})},t=>{a.getDelegate()==e&&a.setDelegate(l),e.unPatchPromiseForTest(),i.run(()=>{s(t)})},"test");a.setDelegate(e),e.patchPromiseForTest()}),t.current.runGuarded(e,n)}t[n.symbol("asyncTest")]=function t(n){return e.jasmine?function(e){e||((e=function(){}).fail=function(e){throw e}),r(n,this,e,t=>{if("string"==typeof t)return e.fail(new Error(t));e.fail(t)})}:function(){return new Promise((e,t)=>{r(n,this,e,t)})}}}),
/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
Zone.__load_patch("fakeasync",(e,t,n)=>{const r=t&&t.FakeAsyncTestZoneSpec,s=t&&t.ProxyZoneSpec;let i=null;function o(){i&&i.unlockDatePatch(),i=null,s&&s.assertPresent().resetDelegate()}function c(){if(null==i&&(i=t.current.get("FakeAsyncTestZoneSpec"),null==i))throw new Error("The code should be running in the fakeAsync zone to call this function");return i}function a(){c().flushMicrotasks()}t[n.symbol("fakeAsyncTest")]={resetFakeAsyncZone:o,flushMicrotasks:a,discardPeriodicTasks:function u(){c().pendingPeriodicTimers.length=0},tick:function l(e=0,t=!1){c().tick(e,null,t)},flush:function h(e){return c().flush(e)},fakeAsync:function d(e){const n=function(...n){const c=s.assertPresent();if(t.current.get("FakeAsyncTestZoneSpec"))throw new Error("fakeAsync() calls can not be nested");try{if(!i){if(c.getDelegate()instanceof r)throw new Error("fakeAsync() calls can not be nested");i=new r}let t;const s=c.getDelegate();c.setDelegate(i),i.lockDatePatch();try{t=e.apply(this,n),a()}finally{c.setDelegate(s)}if(i.pendingPeriodicTimers.length>0)throw new Error(`${i.pendingPeriodicTimers.length} `+"periodic timer(s) still in the queue.");if(i.pendingTimers.length>0)throw new Error(`${i.pendingTimers.length} timer(s) still in the queue.`);return t}finally{o()}};return n.isFakeAsync=!0,n}}}),
/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
