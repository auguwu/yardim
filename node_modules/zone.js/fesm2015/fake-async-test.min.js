 ...
 * found in the LICENSE file at https://angular.io/license
 */
Zone.__load_patch("fakeasync",(e,t,s)=>{const r=t&&t.FakeAsyncTestZoneSpec,i=t&&t.ProxyZoneSpec;let n=null;function c(){n&&n.unlockDatePatch(),n=null,i&&i.assertPresent().resetDelegate()}function a(){if(null==n&&(n=t.current.get("FakeAsyncTestZoneSpec"),null==n))throw new Error("The code should be running in the fakeAsync zone to call this function");return n}function o(){a().flushMicrotasks()}t[s.symbol("fakeAsyncTest")]={resetFakeAsyncZone:c,flushMicrotasks:o,discardPeriodicTasks:function u(){a().pendingPeriodicTimers.length=0},tick:function h(e=0,t=!1){a().tick(e,null,t)},flush:function l(e){return a().flush(e)},fakeAsync:function d(e){const s=function(...s){const a=i.assertPresent();if(t.current.get("FakeAsyncTestZoneSpec"))throw new Error("fakeAsync() calls can not be nested");try{if(!n){if(a.getDelegate()instanceof r)throw new Error("fakeAsync() calls can not be nested");n=new r}let t;const i=a.getDelegate();a.setDelegate(n),n.lockDatePatch();try{t=e.apply(this,s),o()}finally{a.setDelegate(i)}if(n.pendingPeriodicTimers.length>0)throw new Error(`${n.pendingPeriodicTimers.length} `+"periodic timer(s) still in the queue.");if(n.pendingTimers.length>0)throw new Error(`${n.pendingTimers.length} timer(s) still in the queue.`);return t}finally{c()}};return s.isFakeAsync=!0,s}}});