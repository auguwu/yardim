 ...
 * found in the LICENSE file at https://angular.io/license
 */
Zone.__load_patch("asynctest",(e,s,n)=>{function t(e,n,t,o){const r=s.current,i=s.AsyncTestZoneSpec;if(void 0===i)throw new Error("AsyncTestZoneSpec is needed for the async() test helper but could not be found. Please make sure that your environment includes zone.js/dist/async-test.js");const a=s.ProxyZoneSpec;if(void 0===a)throw new Error("ProxyZoneSpec is needed for the async() test helper but could not be found. Please make sure that your environment includes zone.js/dist/proxy.js");const c=a.get();a.assertPresent();const h=s.current.getZoneWith("ProxyZoneSpec"),l=c.getDelegate();return h.parent.run(()=>{const e=new i(()=>{c.getDelegate()==e&&c.setDelegate(l),e.unPatchPromiseForTest(),r.run(()=>{t()})},s=>{c.getDelegate()==e&&c.setDelegate(l),e.unPatchPromiseForTest(),r.run(()=>{o(s)})},"test");c.setDelegate(e),e.patchPromiseForTest()}),s.current.runGuarded(e,n)}s[n.symbol("asyncTest")]=function s(n){return e.jasmine?function(e){e||((e=function(){}).fail=function(e){throw e}),t(n,this,e,s=>{if("string"==typeof s)return e.fail(new Error(s));e.fail(s)})}:function(){return new Promise((e,s)=>{t(n,this,e,s)})}}});