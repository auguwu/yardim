 ...
 * found in the LICENSE file at https://angular.io/license
 */
const taskSymbol=zoneSymbol("zoneTask");function patchTimer(e,t,n,o){let r=null,a=null;n+=o;const s={};function i(t){const n=t.data;return n.args[0]=function o(){try{t.invoke.apply(this,arguments)}finally{t.data&&t.data.isPeriodic||("number"==typeof n.handleId?delete s[n.handleId]:n.handleId&&(n.handleId[taskSymbol]=null))}},n.handleId=r.apply(e,n.args),t}function c(t){return a.call(e,t.data.handleId)}r=patchMethod(e,t+=o,n=>function(r,a){if("function"==typeof a[0]){const e=scheduleMacroTaskWithCurrentZone(t,a[0],{isPeriodic:"Interval"===o,delay:"Timeout"===o||"Interval"===o?a[1]||0:void 0,args:a},i,c);if(!e)return e;const n=e.data.handleId;return"number"==typeof n?s[n]=e:n&&(n[taskSymbol]=e),n&&n.ref&&n.unref&&"function"==typeof n.ref&&"function"==typeof n.unref&&(e.ref=n.ref.bind(n),e.unref=n.unref.bind(n)),"number"==typeof n||n?n:e}return n.apply(e,a)}),a=patchMethod(e,n,t=>function(n,o){const r=o[0];let a;"number"==typeof r?a=s[r]:(a=r&&r[taskSymbol],a||(a=r)),a&&"string"==typeof a.type?"notScheduled"!==a.state&&(a.cancelFn&&a.data.isPeriodic||0===a.runCount)&&("number"==typeof r?delete s[r]:r&&(r[taskSymbol]=null),a.zone.cancelTask(a)):t.apply(e,o)})}
/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
