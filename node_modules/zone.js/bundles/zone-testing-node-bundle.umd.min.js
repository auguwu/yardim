var __spreadArrays=this&&this.__spreadArrays||function(){for(var e=0,t=0,n=arguments.length;t<n;t++)e+=arguments[t].length;var r=Array(e),o=0;for(t=0;t<n;t++)for(var i=arguments[t],s=0,a=i.length;s<a;s++,o++)r[o]=i[s];return r};
/**
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var w=!1;if("undefined"!=typeof window)try{var E=Object.defineProperty({},"passive",{get:function(){w=!0}});window.addEventListener("test",E,E),window.removeEventListener("test",E,E)}catch(e){w=!1}var Z={useG:!0},D={},C={},A=new RegExp("^"+o+"(\\w+)(true|false)$"),j=a("propagationStopped");function I(e,t){var n=(t?t(e):e)+"false",r=(t?t(e):e)+"true",i=o+n,s=o+r;D[e]={},D[e].false=i,D[e].true=s}function O(e,t){if(!t){var n=[];for(var r in e){var o=A.exec(r),i=o&&o[1];if(i&&(!t||i===t)){var s=e[r];if(s)for(var a=0;a<s.length;a++)n.push(s[a])}}return n}var c=D[t];c||(I(t),c=D[t]);var u=e[c.false],l=e[c.true];return u?l?u.concat(l):u.slice():l?l.slice():[]}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var F=a("zoneTask");function x(e,t,n,r){var o=null,i=null;n+=r;var a={};function c(t){var n=t.data;return n.args[0]=function r(){try{t.invoke.apply(this,arguments)}finally{t.data&&t.data.isPeriodic||("number"==typeof n.handleId?delete a[n.handleId]:n.handleId&&(n.handleId[F]=null))}},n.handleId=o.apply(e,n.args),t}function u(t){return i.call(e,t.data.handleId)}o=b(e,t+=r,(function(n){return function(o,i){if("function"==typeof i[0]){var l=s(t,i[0],{isPeriodic:"Interval"===r,delay:"Timeout"===r||"Interval"===r?i[1]||0:void 0,args:i},c,u);if(!l)return l;var h=l.data.handleId;return"number"==typeof h?a[h]=l:h&&(h[F]=l),h&&h.ref&&h.unref&&"function"==typeof h.ref&&"function"==typeof h.unref&&(l.ref=h.ref.bind(h),l.unref=h.unref.bind(h)),"number"==typeof h||h?h:l}return n.apply(e,i)}})),i=b(e,n,(function(t){return function(n,r){var o,i=r[0];"number"==typeof i?o=a[i]:(o=i&&i[F])||(o=i),o&&"string"==typeof o.type?"notScheduled"!==o.state&&(o.cancelFn&&o.data.isPeriodic||0===o.runCount)&&("number"==typeof i?delete a[i]:i&&(i[F]=null),o.zone.cancelTask(o)):t.apply(e,r)}}))}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
Zone.__load_patch("asynctest",(function(e,t,n){function r(e,n,r,o){var i=t.current,s=t.AsyncTestZoneSpec;if(void 0===s)throw new Error("AsyncTestZoneSpec is needed for the async() test helper but could not be found. Please make sure that your environment includes zone.js/dist/async-test.js");var a=t.ProxyZoneSpec;if(void 0===a)throw new Error("ProxyZoneSpec is needed for the async() test helper but could not be found. Please make sure that your environment includes zone.js/dist/proxy.js");var c=a.get();a.assertPresent();var u=t.current.getZoneWith("ProxyZoneSpec"),l=c.getDelegate();return u.parent.run((function(){var e=new s((function(){c.getDelegate()==e&&c.setDelegate(l),e.unPatchPromiseForTest(),i.run((function(){r()}))}),(function(t){c.getDelegate()==e&&c.setDelegate(l),e.unPatchPromiseForTest(),i.run((function(){o(t)}))}),"test");c.setDelegate(e),e.patchPromiseForTest()})),t.current.runGuarded(e,n)}t[n.symbol("asyncTest")]=function t(n){return e.jasmine?function(e){e||((e=function(){}).fail=function(e){throw e}),r(n,this,e,(function(t){if("string"==typeof t)return e.fail(new Error(t));e.fail(t)}))}:function(){var e=this;return new Promise((function(t,o){r(n,e,t,o)}))}}})),
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
Zone.__load_patch("fakeasync",(function(e,t,n){var r=t&&t.FakeAsyncTestZoneSpec,o=t&&t.ProxyZoneSpec,i=null;function s(){i&&i.unlockDatePatch(),i=null,o&&o.assertPresent().resetDelegate()}function a(){if(null==i&&null==(i=t.current.get("FakeAsyncTestZoneSpec")))throw new Error("The code should be running in the fakeAsync zone to call this function");return i}function c(){a().flushMicrotasks()}t[n.symbol("fakeAsyncTest")]={resetFakeAsyncZone:s,flushMicrotasks:c,discardPeriodicTasks:function u(){a().pendingPeriodicTimers.length=0},tick:function l(e,t){void 0===e&&(e=0),void 0===t&&(t=!1),a().tick(e,null,t)},flush:function h(e){return a().flush(e)},fakeAsync:function f(e){var n=function(){for(var n=[],a=0;a<arguments.length;a++)n[a]=arguments[a];var u=o.assertPresent();if(t.current.get("FakeAsyncTestZoneSpec"))throw new Error("fakeAsync() calls can not be nested");try{if(!i){if(u.getDelegate()instanceof r)throw new Error("fakeAsync() calls can not be nested");i=new r}var l=void 0,h=u.getDelegate();u.setDelegate(i),i.lockDatePatch();try{l=e.apply(this,n),c()}finally{u.setDelegate(h)}if(i.pendingPeriodicTimers.length>0)throw new Error(i.pendingPeriodicTimers.length+" periodic timer(s) still in the queue.");if(i.pendingTimers.length>0)throw new Error(i.pendingTimers.length+" timer(s) still in the queue.");return l}finally{s()}};return n.isFakeAsync=!0,n}}})),
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
