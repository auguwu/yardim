...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var x=!1;if("undefined"!=typeof window)try{var R=Object.defineProperty({},"passive",{get:function(){x=!0}});window.addEventListener("test",R,R),window.removeEventListener("test",R,R)}catch(e){x=!1}var L={useG:!0},M={},N={},H=new RegExp("^"+s+"(\\w+)(true|false)$"),A=l("propagationStopped");function F(e,t){var n=(t?t(e):e)+"false",r=(t?t(e):e)+"true",o=s+n,a=s+r;M[e]={},M[e].false=o,M[e].true=a}function q(e,t,r){var o=r&&r.add||"addEventListener",a=r&&r.rm||"removeEventListener",i=r&&r.listeners||"eventListeners",c=r&&r.rmAll||"removeAllListeners",u=l(o),f="."+o+":",p=function(e,t,n){if(!e.isRemoved){var r=e.callback;"object"==typeof r&&r.handleEvent&&(e.callback=function(e){return r.handleEvent(e)},e.originalDelegate=r),e.invoke(e,t,[n]);var o=e.options;o&&"object"==typeof o&&o.once&&t[a].call(t,n.type,e.originalDelegate?e.originalDelegate:e.callback,o)}},h=function(t){if(t=t||e.event){var n=this||t.target||e,r=n[M[t.type].false];if(r)if(1===r.length)p(r[0],n,t);else for(var o=r.slice(),a=0;a<o.length&&(!t||!0!==t[A]);a++)p(o[a],n,t)}},d=function(t){if(t=t||e.event){var n=this||t.target||e,r=n[M[t.type].true];if(r)if(1===r.length)p(r[0],n,t);else for(var o=r.slice(),a=0;a<o.length&&(!t||!0!==t[A]);a++)p(o[a],n,t)}};function v(t,r){if(!t)return!1;var p=!0;r&&void 0!==r.useG&&(p=r.useG);var v=r&&r.vh,g=!0;r&&void 0!==r.chkDup&&(g=r.chkDup);var m=!1;r&&void 0!==r.rt&&(m=r.rt);for(var _=t;_&&!_.hasOwnProperty(o);)_=n(_);if(!_&&t[o]&&(_=t),!_)return!1;if(_[u])return!1;var k,b=r&&r.eventNameToString,T={},E=_[u]=_[o],w=_[l(a)]=_[a],Z=_[l(i)]=_[i],S=_[l(c)]=_[c];function P(e,t){return!x&&"object"==typeof e&&e?!!e.capture:x&&t?"boolean"==typeof e?{capture:e,passive:!0}:e?"object"==typeof e&&!1!==e.passive?Object.assign(Object.assign({},e),{passive:!0}):e:{passive:!0}:e}r&&r.prepend&&(k=_[l(r.prepend)]=_[r.prepend]);var O=p?function(e){if(!T.isExisting)return E.call(T.target,T.eventName,T.capture?d:h,T.options)}:function(e){return E.call(T.target,T.eventName,e.invoke,T.options)},D=p?function(e){if(!e.isRemoved){var t=M[e.eventName],n=void 0;t&&(n=t[e.capture?"true":"false"]);var r=n&&e.target[n];if(r)for(var o=0;o<r.length;o++)if(r[o]===e){r.splice(o,1),e.isRemoved=!0,0===r.length&&(e.allRemoved=!0,e.target[n]=null);break}}if(e.allRemoved)return w.call(e.target,e.eventName,e.capture?d:h,e.options)}:function(e){return w.call(e.target,e.eventName,e.invoke,e.options)},C=r&&r.diff?r.diff:function(e,t){var n=typeof t;return"function"===n&&e.callback===t||"object"===n&&e.originalDelegate===t},z=Zone[l("UNPATCHED_EVENTS")],I=e[l("PASSIVE_EVENTS")],R=function(t,n,o,a,i,s){return void 0===i&&(i=!1),void 0===s&&(s=!1),function(){var c=this||e,u=arguments[0];r&&r.transferEventName&&(u=r.transferEventName(u));var l=arguments[1];if(!l)return t.apply(this,arguments);if(y&&"uncaughtException"===u)return t.apply(this,arguments);var f=!1;if("function"!=typeof l){if(!l.handleEvent)return t.apply(this,arguments);f=!0}if(!v||v(t,l,c,arguments)){var h=x&&!!I&&-1!==I.indexOf(u),d=P(arguments[2],h);if(z)for(var m=0;m<z.length;m++)if(u===z[m])return h?t.call(c,u,l,d):t.apply(this,arguments);var _=!!d&&("boolean"==typeof d||d.capture),k=!(!d||"object"!=typeof d)&&d.once,E=Zone.current,w=M[u];w||(F(u,b),w=M[u]);var Z,S=w[_?"true":"false"],O=c[S],D=!1;if(O){if(D=!0,g)for(m=0;m<O.length;m++)if(C(O[m],l))return}else O=c[S]=[];var j=c.constructor.name,R=N[j];R&&(Z=R[u]),Z||(Z=j+n+(b?b(u):u)),T.options=d,k&&(T.options.once=!1),T.target=c,T.capture=_,T.eventName=u,T.isExisting=D;var H=p?L:void 0;H&&(H.taskData=T);var A=E.scheduleEventTask(Z,l,H,o,a);return T.target=null,H&&(H.taskData=null),k&&(d.once=!0),(x||"boolean"!=typeof A.options)&&(A.options=d),A.target=c,A.capture=_,A.eventName=u,f&&(A.originalDelegate=l),s?O.unshift(A):O.push(A),i?c:void 0}}};return _[o]=R(E,f,O,D,m),k&&(_.prependListener=R(k,".prependListener:",(function(e){return k.call(T.target,T.eventName,e.invoke,T.options)}),D,m,!0)),_[a]=function(){var t=this||e,n=arguments[0];r&&r.transferEventName&&(n=r.transferEventName(n));var o=arguments[2],a=!!o&&("boolean"==typeof o||o.capture),i=arguments[1];if(!i)return w.apply(this,arguments);if(!v||v(w,i,t,arguments)){var c,u=M[n];u&&(c=u[a?"true":"false"]);var l=c&&t[c];if(l)for(var f=0;f<l.length;f++){var p=l[f];if(C(p,i)){if(l.splice(f,1),p.isRemoved=!0,0===l.length&&(p.allRemoved=!0,t[c]=null,"string"==typeof n)){var h=s+"ON_PROPERTY"+n;t[h]=null}return p.zone.cancelTask(p),m?t:void 0}}return w.apply(this,arguments)}},_[i]=function(){var t=this||e,n=arguments[0];r&&r.transferEventName&&(n=r.transferEventName(n));for(var o=[],a=G(t,b?b(n):n),i=0;i<a.length;i++){var s=a[i],c=s.originalDelegate?s.originalDelegate:s.callback;o.push(c)}return o},_[c]=function(){var t=this||e,n=arguments[0];if(n){r&&r.transferEventName&&(n=r.transferEventName(n));var o=M[n];if(o){var i=o.false,s=o.true,u=t[i],l=t[s];if(u){var f=u.slice();for(d=0;d<f.length;d++)this[a].call(this,n,(p=f[d]).originalDelegate?p.originalDelegate:p.callback,p.options)}if(l)for(f=l.slice(),d=0;d<f.length;d++){var p;this[a].call(this,n,(p=f[d]).originalDelegate?p.originalDelegate:p.callback,p.options)}}}else{for(var h=Object.keys(t),d=0;d<h.length;d++){var v=h[d],g=H.exec(v),y=g&&g[1];y&&"removeListener"!==y&&this[c].call(this,y)}this[c].call(this,"removeListener")}if(m)return this},j(_[o],E),j(_[a],w),S&&j(_[c],S),Z&&j(_[i],Z),!0}for(var g=[],m=0;m<t.length;m++)g[m]=v(t[m],r);return g}function G(e,t){if(!t){var n=[];for(var r in e){var o=H.exec(r),a=o&&o[1];if(a&&(!t||a===t)){var i=e[r];if(i)for(var s=0;s<i.length;s++)n.push(i[s])}}return n}var c=M[t];c||(F(t),c=M[t]);var u=e[c.false],l=e[c.true];return u?l?u.concat(l):u.slice():l?l.slice():[]}function B(e,t){var n=e.Event;n&&n.prototype&&t.patchMethod(n.prototype,"stopImmediatePropagation",(function(e){return function(t,n){t[A]=!0,e&&e.apply(t,n)}}))}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var ae=l("zoneTask");function ie(e,t,n,r){var o=null,a=null;n+=r;var i={};function s(t){var n=t.data;return n.args[0]=function r(){try{t.invoke.apply(this,arguments)}finally{t.data&&t.data.isPeriodic||("number"==typeof n.handleId?delete i[n.handleId]:n.handleId&&(n.handleId[ae]=null))}},n.handleId=o.apply(e,n.args),t}function c(t){return a.call(e,t.data.handleId)}o=O(e,t+=r,(function(n){return function(o,a){if("function"==typeof a[0]){var l=u(t,a[0],{isPeriodic:"Interval"===r,delay:"Timeout"===r||"Interval"===r?a[1]||0:void 0,args:a},s,c);if(!l)return l;var f=l.data.handleId;return"number"==typeof f?i[f]=l:f&&(f[ae]=l),f&&f.ref&&f.unref&&"function"==typeof f.ref&&"function"==typeof f.unref&&(l.ref=f.ref.bind(f),l.unref=f.unref.bind(f)),"number"==typeof f||f?f:l}return n.apply(e,a)}})),a=O(e,n,(function(t){return function(n,r){var o,a=r[0];"number"==typeof a?o=i[a]:(o=a&&a[ae])||(o=a),o&&"string"==typeof o.type?"notScheduled"!==o.state&&(o.cancelFn&&o.data.isPeriodic||0===o.runCount)&&("number"==typeof a?delete i[a]:a&&(a[ae]=null),o.zone.cancelTask(o)):t.apply(e,r)}}))}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
